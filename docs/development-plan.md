...
- 跨服中心布局：
  - 使用全覆盖手游内页，不做模块化卡片堆叠。
  - 顶部展示跨服分组、报名状态、当前荣誉和关闭按钮。
  - 第一屏优先展示跨服创业大赛报名/排名、跨服商会赛季状态和奖励倒计时。
  - 中部使用横向频道条：创业大赛、跨服商会、跨服历史、奖励规则。
  - 榜单使用中国手游常见结构：前三突出、我的排名固定条、奖励预览条。
  - 底部固定主操作：报名跨服、结算跨服、报名商会赛季。
- 边界：
  - 不改跨服结算算法，不新增奖励，不改变称号规则。
  - 只做入口独立、信息层级调整、视觉收口和回归锁定。
- 验收标准：
  - 首页跨服入口可见且不遮挡右侧其他运营入口、主线任务条和底部导航。
  - 跨服独立页首屏有报名、排名、奖励和主操作。
