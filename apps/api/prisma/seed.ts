...
const randomTaskConfigs = [
  ...
  {
    id: "random-employee-finance-reconcile",
    category: "employee",
    title: "财务对账压力",
    description: "月末回款和成本记录需要复核，财务同事担心错漏影响经营判断。",
    source: "财务提醒",
    optionALabel: "安排交叉复核",
    optionAResult: "现金账目更清楚，团队对经营节奏更有把握。",
    optionAActionPower: -15,
    optionACash: -10000,
    optionAReputation: 150,
    optionACompanyExperience: 70,
    optionBLabel: "先按旧表提交",
    optionBResult: "短期省下精力，但后续追账和补录压力增加。",
    optionBActionPower: -5,
    optionBCash: 0,
    optionBReputation: -80,
    optionBCompanyExperience: 35,
  ...
  {
    id: "random-employee-customer-complaint",
    category: "employee",
    title: "客服投诉堆积",
    description: "客服同事反馈近期投诉集中，继续拖延会影响团队信心和客户满意度。",
    source: "客服日报",
    optionALabel: "抽人处理重点投诉",
    optionAResult: "客户情绪回落，客服团队获得支撑。",
    optionAActionPower: -20,
    optionACash: -10000,
    optionAReputation: 220,
    optionACompanyExperience: 75,
    optionBLabel: "先发统一说明",
    optionBResult: "处理成本较低，但客服压力和客户疑虑仍需跟进。",
    optionBActionPower: -5,
    optionBCash: 0,
    optionBReputation: -100,
    optionBCompanyExperience: 35,
    riskLabel: "客服压力",
    knowledgeId: "platform-user-agreement",
    sortOrder: 27,
    isActive: true
  },
  {
    id: "random-employee-legal-review",
    category: "employee",
    title: "法务条款复核",
    description: "新客户合同里有交付和赔付条款，法务建议签约前再复核一次。",
    source: "法务提醒",
    optionALabel: "逐条复核风险",
    optionAResult: "合同风险下降，销售和交付口径更稳。",
    optionAActionPower: -15,
    optionACash: -20000,
    optionAReputation: 180,
    optionACompanyExperience: 75,
    optionBLabel: "先按模板签约",
    optionBResult: "签约速度更快，但后续履约争议风险上升。",
    optionBActionPower: -5,
    optionBCash: 50000,
    optionBReputation: -120,
    optionBCompanyExperience: 35,
  ...
  {
    id: "random-employee-ops-runbook",
    category: "employee",
    title: "运营手册缺页",
    description: "运营同事发现活动流程靠口头传递，新人接手时容易漏步骤。",
    source: "运营复盘",
    optionALabel: "补齐关键流程",
    optionAResult: "运营交接更稳，员工压力下降。",
    optionAActionPower: -15,
    optionACash: -10000,
    optionAReputation: 150,
    optionACompanyExperience: 70,
    optionBLabel: "先靠老员工带着做",
    optionBResult: "当前排期不变，但老员工负担继续加重。",
    optionBActionPower: 0,
    optionBCash: 0,
    optionBReputation: -80,
    optionBCompanyExperience: 35,
  ...
  {
    id: "random-employee-product-quality-review",
    category: "employee",
    title: "产品质量复盘",
    description: "新版本上线后出现集中反馈，产品和测试同事希望先做一次质量复盘。",
    source: "产品周会",
    optionALabel: "暂停小需求复盘质量",
    optionAResult: "产品稳定性提升，团队对后续迭代更有信心。",
    optionAActionPower: -20,
    optionACash: -10000,
    optionAReputation: 220,
    optionACompanyExperience: 80,
    optionBLabel: "继续赶下一版",
    optionBResult: "短期迭代不断，但质量问题可能继续累积。",
    optionBActionPower: -5,
    optionBCash: 30000,
    optionBReputation: -120,
    optionBCompanyExperience: 40,
  ...
  {
    id: "random-employee-market-campaign-review",
    category: "employee",
    title: "市场活动复盘",
    description: "市场活动带来线索，但销售和运营对线索质量评价不一致。",
    source: "市场复盘",
    optionALabel: "复盘线索质量",
    optionAResult: "市场投放更聚焦，跨岗位协作更顺。",
    optionAActionPower: -15,
    optionACash: -10000,
    optionAReputation: 180,
    optionACompanyExperience: 70,
    optionBLabel: "继续扩大投放",
    optionBResult: "短期声量提升，但团队筛选压力变大。",
    optionBActionPower: -5,
    optionBCash: -30000,
    optionBReputation: 80,
    optionBCompanyExperience: 40,
  ...
  {
    id: "random-employee-hr-probation-check",
    category: "employee",
    title: "新人试用评估",
    description: "几名新人快到试用节点，人事希望提前确认目标和反馈。",
    source: "人事提醒",
    optionALabel: "逐个做试用反馈",
    optionAResult: "新人预期更清楚，团队磨合更稳。",
    optionAActionPower: -15,
    optionACash: -10000,
    optionAReputation: 160,
    optionACompanyExperience: 70,
    optionBLabel: "月底统一评估",
    optionBResult: "当前安排轻一些，但新人不确定感继续存在。",
    optionBActionPower: 0,
    optionBCash: 0,
    optionBReputation: -80,
    optionBCompanyExperience: 35,
  ...
  {
    id: "random-employee-data-access-audit",
    category: "employee",
    title: "客户数据权限复核",
    description: "客服和研发都需要查看客户数据，权限边界需要重新确认。",
    source: "安全提醒",
    optionALabel: "整理权限清单",
    optionAResult: "数据使用边界更清楚，客户信任更稳。",
    optionAActionPower: -15,
    optionACash: -10000,
    optionAReputation: 200,
    optionACompanyExperience: 75,
    optionBLabel: "先沿用原权限",
    optionBResult: "处理更快，但数据安全和内控风险继续存在。",
    optionBActionPower: 0,
    optionBCash: 0,
    optionBReputation: -120,
    optionBCompanyExperience: 35,
    riskLabel: "数据权限",
    knowledgeId: "data-leak-response",
    sortOrder: 33,
    isActive: true
  },
  {
    id: "random-employee-sales-script-drift",
    category: "employee",
    title: "销售话术跑偏",
    description: "部分销售同事为了抢单夸大了交付能力，交付团队开始担心承诺失控。",
    source: "销售复盘",
    optionALabel: "统一销售话术",
    optionAResult: "客户预期更稳，交付压力下降。",
    optionAActionPower: -15,
    optionACash: -10000,
    optionAReputation: 210,
    optionACompanyExperience: 70,
    optionBLabel: "先保住签约节奏",
    optionBResult: "短期收入机会保留，但团队信任和客户预期承压。",
    optionBActionPower: -5,
    optionBCash: 60000,
    optionBReputation: -130,
    optionBCompanyExperience: 35,
    riskLabel: "销售口径",
    knowledgeId: "contract-formation-basics",
    sortOrder: 34,
  ...
  {
    id: "random-employee-key-person-backup",
    category: "employee",
    title: "关键岗位缺备份",
    description: "一个核心岗位只有一人熟悉流程，团队担心请假或离岗时没人接手。",
    source: "经理提醒",
    optionALabel: "安排岗位备份",
    optionAResult: "关键岗位更稳，团队安全感提升。",
    optionAActionPower: -15,
    optionACash: -10000,
    optionAReputation: 170,
    optionACompanyExperience: 75,
    optionBLabel: "先维持当前分工",
    optionBResult: "短期效率不变，但单点风险继续存在。",
    optionBActionPower: 0,
    optionBCash: 0,
    optionBReputation: -90,
    optionBCompanyExperience: 35,
  ...
  {
    id: "random-employee-remote-collaboration",
    category: "employee",
    title: "异地协作摩擦",
    description: "远程成员和现场成员信息不同步，任务交接开始反复确认。",
    source: "团队例会",
    optionALabel: "固定同步节奏",
    optionAResult: "协作节奏更清楚，员工压力下降。",
    optionAActionPower: -10,
    optionACash: -10000,
    optionAReputation: 140,
    optionACompanyExperience: 65,
    optionBLabel: "让各组自行同步",
    optionBResult: "管理成本较低，但误解和返工风险增加。",
    optionBActionPower: 0,
    optionBCash: 0,
    optionBReputation: -80,
    optionBCompanyExperience: 30,
  ...
  {
    id: "random-employee-after-sales-training",
    category: "employee",
    title: "售后培训缺口",
    description: "新客户上线后问题集中，售后同事希望补一轮产品培训。",
    source: "售后简报",
    optionALabel: "安排产品培训",
    optionAResult: "售后响应更稳，客户满意度回升。",
    optionAActionPower: -15,
    optionACash: -20000,
    optionAReputation: 220,
    optionACompanyExperience: 75,
    optionBLabel: "整理常见问答",
    optionBResult: "成本较低，但复杂问题仍要依赖少数骨干。",
    optionBActionPower: -5,
    optionBCash: 0,
    optionBReputation: -60,
    optionBCompanyExperience: 40,
...
const competitorActionConfigs = [
  ...
  {
    id: "ai-service-sla-attack",
    trackId: "ai-tools",
    competitorName: "启明智能",
    actionType: "public_opinion",
    title: "竞品放大服务口碑问题",
    summary: "启明智能集中传播模型交付延迟案例，试用客户开始追问服务承诺。",
    cashImpact: -30000,
    monthlyIncomeImpact: -42000,
    monthlyExpenseImpact: 22000,
    reputationImpact: -520,
    employeeSatisfactionImpact: -2,
    customerSatisfactionImpact: -5,
    marketShareDeltaBasisPoints: -82,
    competitorShareDeltaBasisPoints: 105,
    pricePressure: 4,
    talentPressure: 3,
    policyRiskDelta: 0,
    responseCost: 105000,
    responseShareDeltaBasisPoints: 140,
    responseReputationImpact: 620,
    sortOrder: 9
  },
  {
    id: "ai-data-security-audit",
    trackId: "ai-tools",
    competitorName: "矩阵智服",
    actionType: "public_opinion",
    title: "竞品质疑数据安全",
    summary: "矩阵智服强调私有化安全方案，客户要求你补充数据权限说明。",
    cashImpact: -50000,
    monthlyIncomeImpact: -40000,
    monthlyExpenseImpact: 50000,
    reputationImpact: -760,
    employeeSatisfactionImpact: -2,
    customerSatisfactionImpact: -6,
    marketShareDeltaBasisPoints: -110,
    competitorShareDeltaBasisPoints: 130,
    pricePressure: 3,
    talentPressure: 6,
    policyRiskDelta: 10,
    responseCost: 145000,
    responseShareDeltaBasisPoints: 170,
    responseReputationImpact: 820,
    sortOrder: 10
  },
  {
    id: "saas-renewal-discount",
    trackId: "enterprise-saas",
    competitorName: "海岳云服",
    actionType: "price_war",
    title: "竞品抢续费客户",
    summary: "海岳云服对即将续费客户给出打包折扣，你的续费转化被压低。",
    cashImpact: -35000,
    monthlyIncomeImpact: -65000,
    monthlyExpenseImpact: 18000,
    reputationImpact: -360,
    employeeSatisfactionImpact: 0,
    customerSatisfactionImpact: -4,
    marketShareDeltaBasisPoints: -96,
    competitorShareDeltaBasisPoints: 125,
    pricePressure: 16,
    talentPressure: 2,
    policyRiskDelta: 0,
    responseCost: 115000,
    responseShareDeltaBasisPoints: 150,
    responseReputationImpact: 480,
    sortOrder: 11
  },
  {
    id: "ai-model-benchmark-attack",
    trackId: "ai-tools",
    competitorName: "灵犀算法",
    actionType: "public_opinion",
    title: "竞品发布横评报告",
    summary: "灵犀算法用自有评测报告压低你的模型表现，试用客户开始犹豫。",
    cashImpact: -45000,
    monthlyIncomeImpact: -50000,
    monthlyExpenseImpact: 42000,
    reputationImpact: -680,
    employeeSatisfactionImpact: -2,
    customerSatisfactionImpact: -4,
    marketShareDeltaBasisPoints: -100,
    competitorShareDeltaBasisPoints: 135,
    pricePressure: 5,
    talentPressure: 8,
    policyRiskDelta: 3,
    responseCost: 140000,
    responseShareDeltaBasisPoints: 165,
    responseReputationImpact: 760,
    sortOrder: 12
  },
  {
    id: "saas-integration-lock",
    trackId: "enterprise-saas",
    competitorName: "方舟协同",
    actionType: "price_war",
    title: "竞品捆绑集成服务",
    summary: "方舟协同把接口定制打进套餐，客户开始比较你的交付成本。",
    cashImpact: -40000,
    monthlyIncomeImpact: -52000,
    monthlyExpenseImpact: 28000,
    reputationImpact: -380,
    employeeSatisfactionImpact: -1,
    customerSatisfactionImpact: -4,
    marketShareDeltaBasisPoints: -92,
    competitorShareDeltaBasisPoints: 120,
    pricePressure: 14,
    talentPressure: 3,
    policyRiskDelta: 0,
    responseCost: 125000,
    responseShareDeltaBasisPoints: 150,
    responseReputationImpact: 540,
    sortOrder: 13
  },
  {
    id: "ai-cloud-cost-subsidy",
    trackId: "ai-tools",
    competitorName: "算云科技",
    actionType: "price_war",
    title: "竞品补贴算力价格",
    summary: "算云科技用云厂商补贴降低试用价，你的价格压力明显上升。",
    cashImpact: -60000,
    monthlyIncomeImpact: -62000,
    monthlyExpenseImpact: 60000,
    reputationImpact: -420,
    employeeSatisfactionImpact: -1,
    customerSatisfactionImpact: -3,
    marketShareDeltaBasisPoints: -108,
    competitorShareDeltaBasisPoints: 145,
    pricePressure: 20,
    talentPressure: 4,
    policyRiskDelta: 0,
    responseCost: 155000,
  ...
  {
    id: "saas-partner-exclusivity",
    trackId: "enterprise-saas",
    competitorName: "联企智联",
    actionType: "public_opinion",
    title: "竞品签下独家渠道",
    summary: "联企智联与重点渠道签独家协议，区域线索和伙伴转介绍减少。",
    cashImpact: -42000,
    monthlyIncomeImpact: -56000,
    monthlyExpenseImpact: 26000,
    reputationImpact: -430,
    employeeSatisfactionImpact: -1,
    customerSatisfactionImpact: -3,
    marketShareDeltaBasisPoints: -94,
    competitorShareDeltaBasisPoints: 128,
    pricePressure: 6,
    talentPressure: 3,
    policyRiskDelta: 0,
    responseCost: 120000,
    responseShareDeltaBasisPoints: 152,
    responseReputationImpact: 560,
    sortOrder: 15
  },
  {
    id: "ai-core-engineer-poach",
    trackId: "ai-tools",
    competitorName: "北斗模型",
    actionType: "poach",
    title: "竞品挖角算法骨干",
    summary: "北斗模型向核心算法员工开出高薪，研发稳定性和产品节奏承压。",
    cashImpact: -50000,
    monthlyIncomeImpact: -30000,
    monthlyExpenseImpact: 65000,
    reputationImpact: -520,
    employeeSatisfactionImpact: -6,
    customerSatisfactionImpact: -2,
    marketShareDeltaBasisPoints: -86,
    competitorShareDeltaBasisPoints: 118,
    pricePressure: 4,
    talentPressure: 24,
    policyRiskDelta: 0,
    responseCost: 150000,
  ...
  {
    id: "saas-implementation-delay",
    trackId: "enterprise-saas",
    competitorName: "明道云商",
    actionType: "public_opinion",
    title: "竞品攻击交付延期",
    summary: "明道云商抓住交付延期案例做客户拜访，你的交付可信度受到挑战。",
    cashImpact: -38000,
    monthlyIncomeImpact: -48000,
    monthlyExpenseImpact: 30000,
    reputationImpact: -560,
    employeeSatisfactionImpact: -2,
    customerSatisfactionImpact: -5,
    marketShareDeltaBasisPoints: -90,
    competitorShareDeltaBasisPoints: 122,
    pricePressure: 5,
    talentPressure: 5,
    policyRiskDelta: 0,
    responseCost: 118000,
    responseShareDeltaBasisPoints: 148,
    responseReputationImpact: 650,
    sortOrder: 17
  },
  {
    id: "ai-regulatory-filing",
    trackId: "ai-tools",
    competitorName: "稳策智能",
    actionType: "patent",
    title: "竞品抢先完成备案",
    summary: "稳策智能强调合规备案进度，政企客户要求你补交安全材料。",
    cashImpact: -55000,
    monthlyIncomeImpact: -46000,
    monthlyExpenseImpact: 58000,
    reputationImpact: -720,
    employeeSatisfactionImpact: -2,
    customerSatisfactionImpact: -5,
    marketShareDeltaBasisPoints: -105,
    competitorShareDeltaBasisPoints: 132,
    pricePressure: 3,
    talentPressure: 6,
    policyRiskDelta: 16,
    responseCost: 160000,
  ...
  {
    id: "saas-key-account-poach",
    trackId: "enterprise-saas",
    competitorName: "南辰软件",
    actionType: "poach",
    title: "竞品挖走大客户顾问",
    summary: "南辰软件接触你的大客户顾问，重点客户续约信心开始波动。",
    cashImpact: -45000,
    monthlyIncomeImpact: -62000,
    monthlyExpenseImpact: 36000,
    reputationImpact: -500,
    employeeSatisfactionImpact: -5,
    customerSatisfactionImpact: -4,
    marketShareDeltaBasisPoints: -98,
    competitorShareDeltaBasisPoints: 130,
    pricePressure: 4,
    talentPressure: 22,
    policyRiskDelta: 0,
    responseCost: 135000,
    responseShareDeltaBasisPoints: 155,
    responseReputationImpact: 640,
    sortOrder: 19
  },
  {
    id: "ai-open-source-copycat",
    trackId: "ai-tools",
    competitorName: "开源智造",
    actionType: "patent",
    title: "竞品质疑模型来源",
    summary: "开源智造暗示你的模型训练来源不清，采购方要求补充技术说明。",
    cashImpact: -52000,
    monthlyIncomeImpact: -43000,
    monthlyExpenseImpact: 54000,
    reputationImpact: -780,
    employeeSatisfactionImpact: -2,
    customerSatisfactionImpact: -5,
    marketShareDeltaBasisPoints: -104,
    competitorShareDeltaBasisPoints: 126,
    pricePressure: 4,
    talentPressure: 7,
    policyRiskDelta: 12,
    responseCost: 158000,
    responseShareDeltaBasisPoints: 172,
    responseReputationImpact: 850,
    sortOrder: 20
  }
];
